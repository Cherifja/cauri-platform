    ...
    <div className="bg-cream min-h-full">
      ...
      <form onSubmit={handleSubmit} className="px-5 py-6 flex flex-col gap-3 max-w-md mx-auto">
        ...
        <p className="text-xs text-ink2 text-center mt-2">
          ...
          <Link to="/proprietaire/inscription" className="underline">
            Créer un compte propriétaire
          </Link>
        </p>

        <p className="text-[11px] text-ink2 text-center mt-4 border-t border-sandDeep pt-3">
          Comptes de démo : adjovi@example.com / roger@example.com — mot de passe : motdepasse123
        </p>
      </form>
    </div>
  );
